...
function _reRollDice(dice,limit){
...
function _explodeRoll(dice,limit){
  limit = isNaN(parseInt(limit))?-1:parseInt(limit);
  var expld = 0;
  for(var key in dice){
    var pool = dice[key];
...
function _countSuccess(dice,trgt){
  var success = 0,
